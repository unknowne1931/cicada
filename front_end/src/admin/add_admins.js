...
const Add_admins = () => {
    ...
    const fetch_users_data = () =>{
      try{
        apiAdmin.get('https://stawro.xyz/get/all/total/users/data/from/admins/super')
        .then(res =>{
          if(res.data.data){
    ...
    const Post_data = (e) =>{
      ...
      setAlert(false)
      try{
        apiAdmin.post('https://stawro.xyz/get/employe/login/data/create/new',{username, password, email ,language : lang})
        .then(res =>{
