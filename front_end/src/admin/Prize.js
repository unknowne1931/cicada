...
const Prize = () => {
    ...
    const GetStarsData = () =>{
        try{
            apiAdmin.get(`${"https://stawro.xyz"}/stars/get/all/data/by/stars`)
            .then(res =>{
                if(res.data.data){
    ...
    const RupeePo = (e) =>{
        try{
            e.preventDefault();
            axios.post(`${"https://stawro.xyz"}/rupee/get/for/game`,{rupee})
            .then(res=>{
    ...
    const PostorUpdate = async (e) => {
        try{
            e.preventDefault();
            axios.post(`${"https://stawro.xyz"}/stars/count/one/stars`,{ stars, count: stars_count })
            .then(res =>{
                if(res.data.Status === "OK"){
                    GetStarsData()
                }else if(res.data.Logout === "OUT"){
