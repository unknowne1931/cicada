        ...
        <center>
            <footer>
                ...
                <div className='waves-cnt-02'>
                    ...
                    <div className='waves-cnt-02-sub-01'>
                        <h1 className='waves-cnt-02-sub-01-h1-01'>About Developer</h1><br/>
                        <span><strong>Lokesh Krishna 07:31</strong></span><br/>
                        <span><FontAwesomeIcon icon={faLocationDot} /> : <strong>Dwarka</strong></span><br/>
                        <span><FontAwesomeIcon icon={faEnvelope} /> <strong>anvithapujari036@gmail.com</strong> </span>
                    </div>
