...
const View_qstn = () => {
    ...
    const Get_Data = () =>{
        try{
            api_user_admin.get(`https://stawro.xyz/get/admin/sub/users/posted/datas/011/${user}`)
            .then(res =>{
                if(res.data.data){
            ...
            <div>
                {data.map((user, i)=>{
                    ...
                    const DeleOne_fromId = () =>{
                        try{
                            setAlert(false)
                            api_user_admin.delete(`https://stawro.xyz/delete/users/admin/qno/from/admin/users/${user._id}`)
                            .then(res =>{
