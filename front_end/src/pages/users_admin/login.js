...
const Login = () => {
    ...
    const Post_Login = (e) =>{
      ...
      try{
        e.preventDefault();
        axios.post('https://stawro.xyz/get/and/login/users/admin/pages/auth',{username, password : pass})
        .then(res =>{
    ...
    const Verify_otp = (e) =>{
      ...
      setAlert(false)
      try{
        apiAdmin.post('https://stawro.xyz/verify/users/language/modele/and/otp', {otp, id : ssid})
        .then(res=>{
          if(res.data.Status === "OK"){
